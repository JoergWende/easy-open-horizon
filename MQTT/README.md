...
The initial version of this services specifies the MQ_QMGR_NAME to QM1 and exposes the default ports 1414 and 9443.

Further customisation can be done based on the description in the github project: https://github.com/ibm-messaging/mq-container
